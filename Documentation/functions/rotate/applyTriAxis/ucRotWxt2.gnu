...
plot\
"0Unit.dat" title "Unit Circle" with lines linewidth 2.2 linecolor rgb "#000000",\
"H_002.dat" title "hL1" with lines linewidth 1.1 linecolor rgb "#FF0000",\
"HV2_005.dat" notitle "HV2_005" with lines linewidth 2.0 linecolor rgb "#888888",\
"Plane.dat" notitle "Plane" with points pointsize 0.5 pointtype 7,\
"Plane_001.dat" notitle "Plane_001" with points pointsize 0.5 pointtype 7,\
"V_002.dat" title "vL1" with lines linewidth 1.1 linecolor rgb "#00FF00",\
"V_003.dat" title "hL2" with lines linewidth 1.1 linecolor rgb "#0000FF",\
"zH_003.dat" title "vL2" with lines linewidth 1.1 linecolor rgb "#FF00FF"
