...
void drawTransBox(float *, int, float *, int, float, int, struct rendrInfo);
void drawXyzAxis(float *, int, float *, int, float, struct rendrInfo);
void drawBounds(float *, int, float *, int, float, int, struct rendrInfo);
